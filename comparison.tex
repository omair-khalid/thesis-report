...
\end{equation}
 ...
 \subsubsection{$\mathbb{C}$-CNNs Loss Function}
 In the literature, we find that the output layer can have either complex output, which requires a complex-valued loss function, or some mechanism that projects the data complex domain to real domain, suitable for real-valued loss function.
 
 THEY NEED TO BE DIFFERENTIABLE AS WELL
